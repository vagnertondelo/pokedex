            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              if (pokemonListData.length != 0) {
                return pokemonDetailScreen(
                  name: pokemonListData[pokemonIndex]["name"]["chinese"].toString(),
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage("assets/img/pokebal-bg.png"),
                        ),
                      ),
                    ),
                  ),
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      getBaseStatLabel("HP"),
                                                      getBaseStatLabel("Ataque"),
                                                      getBaseStatLabel("Defesa"),
                                                      getBaseStatLabel("Vel. Ataque"),
                                                      getBaseStatLabel("Vel. Defesa"),
                                                      getBaseStatLabel("Velocidade"),
